...
def plot_boxplot(input_excel_path, output_image_path, x_label='', y_label='', title='', font_scale=1.2,
                 figsize=(12, 8)):
    """
...
def one_dim_code(input_file, output_file):
...
def plot_heatmap(input_excel_path, output_image_path, cmap='coolwarm', annot=True, fmt=".3f", font_scale=1.2,
                 figsize=(10, 8)):
    """
